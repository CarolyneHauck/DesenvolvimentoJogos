...
function carregarMusica() {
	musicaFundo.src = 'snd/musica.mp3';
	musicaFundo.volume = 0.8;
...
var Canvas = {
	...
	_bg:function(){
		...
		gradient.addColorStop(0,'#F69');
		gradient.addColorStop(1,'#609');
